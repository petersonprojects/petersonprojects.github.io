    ...
    for(let i = 0; i < myNodes.length; i++)
    {
        ...
        myNodes[i].addEventListener("click", function(e) {
            if ("IMG" === e.target.tagName) {
                ...
                largeImage.id = "largeImage", largeImage.src = imageSrc //.substr(0, imageSrc.length - 4) + ".png", not sure if this is necessary
                largeImage.style.display = "block", largeImage.style.position = "absolute", largeImage.style.zIndex = "10000",largeImage.addEventListener("load", function() {
